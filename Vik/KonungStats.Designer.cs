namespace Vik
{
    partial class KonungStats
    {
        ...
        {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(KonungStats));
			...
			this.label3.Text = "Умения Конунга";
			// 
			// label4
			// 
			...
			this.label4.Text = "Управление деревней";
			// 
			// label5
			// 
			...
			this.label6.Text = "Репрессии";
			// 
			// numericUpDown1
			// 
			this.numericUpDown1.Location = new System.Drawing.Point(154, 294);
			...
			// numericUpDown2
			// 
			this.numericUpDown2.Location = new System.Drawing.Point(154, 316);
			...
			// numericUpDown3
			// 
			this.numericUpDown3.Location = new System.Drawing.Point(154, 339);
			...
			this.label7.Text = "Вера: ";
			// 
			// label8
			// 
			this.label8.AutoSize = true;
			this.label8.Location = new System.Drawing.Point(92, 239);
			...
			this.pictureBox2.Location = new System.Drawing.Point(630, 379);
